...
void (CODEGEN_FUNCPTR *_ptrc_glGetVertexAttribPointervARB)(GLuint, GLenum, void **) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glVertexAttribPointerARB)(GLuint, GLint, GLenum, GLboolean, GLsizei, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glBufferDataARB)(GLenum, GLsizeiptrARB, const void *, GLenum) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glBufferSubDataARB)(GLenum, GLintptrARB, GLsizeiptrARB, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glGetBufferPointervARB)(GLenum, GLenum, void **) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glGetBufferSubDataARB)(GLenum, GLintptrARB, GLsizeiptrARB, void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glCallLists)(GLsizei, GLenum, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glDrawPixels)(GLsizei, GLsizei, GLenum, GLenum, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glColorPointer)(GLint, GLenum, GLsizei, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glEdgeFlagPointer)(GLsizei, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glIndexPointer)(GLenum, GLsizei, const void *) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glIndexub)(GLubyte) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glIndexubv)(const GLubyte *) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glInterleavedArrays)(GLenum, GLsizei, const void *) = NULL;
GLboolean (CODEGEN_FUNCPTR *_ptrc_glIsTexture)(GLuint) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glNormalPointer)(GLenum, GLsizei, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glTexCoordPointer)(GLint, GLenum, GLsizei, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glVertexPointer)(GLint, GLenum, GLsizei, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glFogCoordPointer)(GLenum, GLsizei, const void *) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glSecondaryColorPointer)(GLint, GLenum, GLsizei, const void *) = NULL;
